...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  let sure = args[1];
  let reason = args.splice(2).join(" ") || `Sebep belirtilmemiş.`;
  ...
  if(ayar.muteLogKanali && client.channels.cache.has(ayar.muteLogKanali)) client.channels.cache.get(ayar.muteLogKanali && ayar.punitiveKanali).send(embed.setDescription(`${uye} üyesi, ${message.author} tarafından **${sure}** boyunca **${reason}** nedeniyle seste mutelendi!`)).catch();
};
