...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  ...
  if(ayar.uyariLogKanali && client.channels.cache.has(ayar.uyariLogKanali)) client.channels.cache.get(ayar.uyariLogKanali && ayar.punitiveKanali).send(embed.setDescription(`${uye} üyesi, ${message.author} tarafından **${reason}** nedeniyle uyarıldı!`)).catch();
};
