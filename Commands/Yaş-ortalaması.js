...
module.exports.execute = async(client, message, args, ayar, emoji) => {
  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.react(client.emojiler.onay); //message.channel.send(embed.setDescription("Bu komutu kullanabilmek için **Yönetici** iznine sahip olmalısın!")).then(x => x.delete({timeout: 5000}));
